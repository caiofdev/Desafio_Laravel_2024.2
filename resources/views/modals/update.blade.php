            ...
            <form method="POST" action="{{ route('admin.update', $admin->id) }}" enctype="multipart/form-data" class="max-w-3xl mx-auto bg-slate-900 p-8 rounded-lg shadow-md">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div class="mt-8 text-center">
                        ...
                        <button type="button" onclick="closeModal('updateModal-{{ $admin->id }}')" class="text-white bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Close</button>
                    </div>
                </div>
            </form>
        </div>
