                            ...
                            <div class="bg-gray-800 p-4 rounded-lg shadow-lg">
                                ...
                                <form action="#" method="POST">
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="deposit_amount" id="deposit_amount" class="bg-gray-700 border border-gray-600 text-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter amount" required />
                                    </div>
                            ...
                            <div class="bg-gray-800 p-4 rounded-lg shadow-lg">
                                ...
                                <form action="#" method="POST">
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="withdraw_amount" id="withdraw_amount" class="bg-gray-700 border border-gray-600 text-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter amount" required />
                                    </div>
