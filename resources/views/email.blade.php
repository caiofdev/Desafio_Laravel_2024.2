<section class="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
    <header>
        <h2 class="text-gray-700 dark:text-gray-200">{{$subject}}
    </header>
    ...
    <footer class="mt-8">
        <p class="text-gray-500 dark:text-gray-400">
            This email was sent to <a href="#" class="text-blue-600 hover:underline dark:text-blue-400" target="_blank">contact@vertexfinancial.com</a>. 
        ...
        <p class="mt-3 text-gray-500 dark:text-gray-400">© Vertex Financial. All Rights Reserved.</p>
    </footer>
</section>